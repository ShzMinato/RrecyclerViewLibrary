...
import com.example.minato.minastore.RecyclerApplication;
...
public class PullToRefreshView extends  ViewGroup {
    ...
    private float deltaY = 0;//正负表示 上滑还是下滑
     ...
     *    下滑
     *       content在滑动到顶部
     *       当前view的左上角相对于母视图的左上角的Y轴偏移量比-10小
     *    下滑
     *       content在底部
     *       当前view的左上角相对于母视图的左上角的Y轴偏移量比10大
     * @return
     */
    private boolean isNeedIntercept() {
     ...
     */
    //是android提供的用来记录滑动速度的一个类，可以监控手指移动的速度。
